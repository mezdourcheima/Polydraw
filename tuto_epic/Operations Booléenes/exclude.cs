...
namespace tuto_epic.Operations_Booleenes
{
    class exclude:shape 
    {
        ...
        public exclude(String Nom, PointF[] Sommets)
        {
            this.Nom = Nom;
        ...
        public void SOUS1(exclude poly1, exclude poly2)
        {
        ...
        public void SOUS2(exclude poly1, exclude poly2)
        {
            List<PointF> clippedCorners = new List<PointF>();
            Boolean inter = Inter(poly1, poly2);
            //  if (inter == true)   //if (il y a une intersection entre les 2 polygones )
        ...
        public Boolean Inter(exclude poly1, exclude poly2)
        {
            List<PointF> clippedCorners = new List<PointF>();
        ...
        public bool IsPointInsidePoly(PointF test, exclude poly)
        {
            int i;
            int j;
            bool result = false;
        ...
        public PointF[] GetIntersectionPoints(PointF l1p1, PointF l1p2, exclude poly)
        {
